  ...
  return (
    ...
    >
      ...
      <section
        id="hero"
        ref={heroRef}
        className="relative flex min-h-[min(90svh,54rem)] flex-col justify-center overflow-hidden border-border border-b bg-background px-5 pt-24 pb-14 md:px-10 md:pb-16 lg:px-14"
      >
        ...
        <div className="relative z-[2] mx-auto w-full max-w-[92rem]">
          ...
          <h1
            data-hero-word
            className="mt-7 font-display text-[clamp(2rem,9.4vw,8.6rem)] text-strong uppercase leading-[0.88] tracking-[-0.055em] md:mt-9"
          >
            ...
            <span className="block whitespace-nowrap">Say it out loud.</span>
