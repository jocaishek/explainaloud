...
export function HeroTake() {
  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-4 border-border border-b px-6 py-5 md:px-8">
      ...
      <ul className="flex flex-col px-6 py-6 md:px-8 md:py-7">
      ...
      <p className="flex items-center gap-2 border-border border-t px-6 py-5 text-[0.95rem] text-muted-foreground md:px-8">
