  ...
  return (
    ...
    >
      ...
      <section
        id="hero"
        ref={heroRef}
        className="relative overflow-hidden bg-[color:var(--panel-deep)] px-5 text-primary-foreground md:px-8"
      >
        {/* The panel is the product, running.

            The ocean is gone. A WebGL field was scenery: it moved forever,
            said nothing, and cost a canvas. What replaced the water is the
            one object no neighbouring landing page can run — the demo
            console, live, above the fold. Wispr Flow's hero is a video of
            its product; this one is the product, with the subject switcher
            working and the take being marked as it plays.

            The headline keeps the marker gesture: "know." takes the green
            stroke, "missed." takes the red, on load, then rests. That and
            the console's own running take are the hero's animation — nothing
            scroll-driven, nothing looping as decoration. */}
        <div className="relative z-[2] mx-auto flex w-full max-w-[76rem] flex-col items-center pt-28 text-center md:pt-32">
          <h1
            data-hero-word
        ...
        {/* `id="live-demo"` stays on the console so the nav link still lands
            here — the separate "Try it here" section merged into the hero
            rather than being deleted. */}
        <div
          id="live-demo"
          data-hero-secondary
          className="relative z-[2] mx-auto mt-10 w-full max-w-[76rem] md:mt-12"
        >
          <div className="lp-product-window">
            <DemoConsole />
          </div>
          <p className="mt-5 flex items-center justify-center gap-2 pb-16 text-primary-foreground/60 text-xs md:pb-20">
            <LockKeyhole className="h-3.5 w-3.5" /> Audio is never stored. Pick
            a subject to switch the take.
          </p>
        </div>
