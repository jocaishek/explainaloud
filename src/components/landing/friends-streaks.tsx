    ...
    >
      <div className="mx-auto grid max-w-[76rem] items-center gap-12 lg:grid-cols-[1fr_0.9fr] lg:gap-20">
        <div>
          ...
          <h2 className="mt-5 max-w-[18ch] font-display text-[clamp(1.7rem,3.8vw,3.4rem)] text-strong leading-[1.02] tracking-[-0.04em]">
            A run of days, and someone who can see it.
          </h2>
          <p className="mt-6 max-w-[36rem] text-muted-foreground leading-relaxed">
