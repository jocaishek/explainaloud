...
export default function PrivacyPage() {
  return (
    <>
      ...
      <p>
        We do not publish profiles to the open web, and search engines cannot
        reach them: everything above requires somebody to be signed in to an
        Explainaloud account.
      </p>
