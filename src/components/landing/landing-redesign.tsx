      ...
      >
        ...
        <div className="relative z-[2] flex min-h-screen flex-col pt-20 md:pt-24">
          ...
          {/* Same measure and same left edge as the headline above it. The
              panel ran centred inside a 46rem box for one build and it read as
              a caption belonging to nothing — content that starts a hundred
              and fifty pixels to the right of every other line on screen. */}
          <div className="relative z-10 mx-auto w-full max-w-[76rem] pb-14 md:pb-16">
            <HeroTake />
          </div>
        </div>
