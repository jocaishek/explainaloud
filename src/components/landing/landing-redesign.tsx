...
import { HeroTake } from "~/components/landing/hero-take";
    ...
    >
      ...
      >
        ...
        {/* The nav is `fixed`, so it takes no flow space — the top padding here is
            ...
            pushed the headline 250px down the screen with 157px under it. The
            centred block clears the bar on its own. */}
        <div className="relative z-[2] flex min-h-screen flex-col pt-20 md:pt-24 lg:pt-0">
          <div className="relative z-10 mx-auto grid w-full max-w-[76rem] flex-1 grid-cols-1 items-center gap-10 py-4 lg:grid-cols-[minmax(0,1.06fr)_minmax(0,0.94fr)] lg:content-center lg:items-start lg:gap-20">
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              <h1 className="relative mx-auto max-w-[12ch] font-display lg:mx-0 lg:max-w-[13ch] text-[clamp(2.35rem,6.1vw,6.4rem)] text-primary-foreground leading-[0.9] tracking-[-0.055em]">
              ...
              <div
                data-hero-secondary
                /* Equal widths when stacked. Two `inline-flex` buttons sized to their
                 own labels and centred gave four different edges down the
                 middle of a phone screen. */
                className="mt-7 flex w-full max-w-[20rem] flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center lg:justify-start"
              >
                <Link
                  href="/signup"
                  data-gsap-hover
                  className="group inline-flex h-12 items-center justify-center gap-5 border border-[var(--accent-solid)] bg-[var(--accent-solid)] px-6 font-medium text-[var(--brand-foreground)] sm:justify-start"
                >
                  Start explaining
                ...
                <a
                  href="#how-it-works"
                  data-gsap-hover
                  className="inline-flex h-12 items-center justify-center border border-white/30 px-6 font-medium text-primary-foreground"
                >
                  See how it works
                </a>
              </div>
