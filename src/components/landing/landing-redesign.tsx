 ...
 */
const HERO_WAVE = [
  18, 34, 26, 48, 40, 62, 44, 30, 22, 36, 54, 68, 56, 42, 28, 20, 32, 50, 64,
  76, 58, 40, 26, 18, 30, 46, 60, 72, 84, 66, 48, 34, 24, 28, 44, 58, 70, 54,
  38, 24, 16, 26, 40, 52, 66, 78, 60, 44, 30, 20, 26, 42, 56, 70, 82, 64, 46,
  32, 22, 28, 40, 54, 68, 50, 36, 24, 18, 26, 38, 48, 34, 22,
] as const;
        ...
        <div className="relative z-[2] flex min-h-screen flex-col pt-20 md:pt-24 lg:py-24">
          ...
          <div className="relative z-10 mx-auto flex w-full max-w-[76rem] flex-1 flex-col items-center justify-center py-4 text-center">
            ...
            <div
              aria-hidden="true"
              data-hero-secondary
              className="mt-9 flex h-14 w-full max-w-[42rem] items-end justify-center gap-[3px] px-4 md:h-[4.5rem]"
            >
              {HERO_BARS.map((bar) => (
                <span
                  key={bar.at}
